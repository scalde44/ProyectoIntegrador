        ...
        <table border="1" width="600" align="center">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="editar.jsp?codigo=<%=u.getCodigo()%>">
                        <image src="Iconos/editar.png" width="30" heigth="30">
                    </a>
                    <a href="ServletMantenimiento?accion=desactivar&codigo=<%=u.getCodigo()%>">
                        <image src="Iconos/desactivar.png" width="30" heigth="30">
                    </a>
                    <a href="ServletMantenimiento?accion=activar&codigo=<%=u.getCodigo()%>">
